...
function validateData($iMin, $iMax){
    if (!is_numeric($iMin) || !is_numeric($iMax)) {
        return false;
    }
    
    if (floor($iMin) != $iMin || floor($iMax) != $iMax) {
        return false;
    }
...
function validateResult($iMin, $iMax, $aDatos){
    if ($iMax <= $iMin) {
        return false;
    }
...
function examen($iMin, $iMax, &$aDatos){
    if (!validateData($iMin, $iMax)) {
        return false;
    }

    if (!validateResult($iMin, $iMax, $aDatos)) {
        return false;
    }
